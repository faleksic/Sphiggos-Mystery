...
class LevelFive extends LevelData {

    LevelFive(Context context, int screenWidth, int screenHeight) {
        data = new LinkedHashMap<>();

        data.put("background", new Background("game_background5", screenWidth, screenHeight, 0, 0));
