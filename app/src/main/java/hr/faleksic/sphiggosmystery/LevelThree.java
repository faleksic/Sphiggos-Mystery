...
class LevelThree extends LevelData {

    LevelThree(Context context, int screenWidth, int screenHeight) {
        data = new LinkedHashMap<>();

        data.put("background", new Background("game_background3", screenWidth, screenHeight, 0, 0));
