...
public class LevelNine extends LevelData {

    public LevelNine(Context context, int screenWidth, int screenHeight) {
        data = new LinkedHashMap<>();

        data.put("background", new Background("game_background9", screenWidth, screenHeight, 0, 0));
